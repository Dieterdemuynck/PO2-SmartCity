...
\subsection{Evaluatie activiteiten}
Jolien en Sarah hebben de technische tekeningen van de kleurensensor, de motorbeugel, de gearmotor, de chassis, het wiel en de ballcaster gemaakt. Rani heeft de vergaderverslagen in \LaTeX gezet en de doorlopende teksten van de eerdere verslagen mooi opgesplitst in de juiste subtitles zoals het voorbeeld op toledo. Ze is bij de groep van modelleren en implementeren gaan vragen waar ze nu exact zitten om al een globaal zicht te krijgen op waar we nu zitten en wat er afgewerkt moet worden.Ze heeft de stuklijst in LaTeX gezet.
