...
% Een goede Gantt-chart maakt gebruik van \emph{links} en \emph{milestones}. Deze laatste definieer je in een lijstje onder de Gantt chart.
	...
	\begin{figure}
		...
		\begin{ganttchart}[hgrid, vgrid, x unit=5mm, time slot format=isodate]{2021-02-12}{2021-04-02}
			...
			%2.2 3D modellen
			\ganttfoobar[name=22]{2.2}{2021-02-26}{2021-03-12} \\
			\ganttlink{21}{22} % 21 must be completed before 22 %pijltje
			%2.3 Technische tekeningen
			\ganttfoobar[name=23]{2.3}{2021-03-05}{2021-03-19} \\
			\ganttlink{22}{23}
			%2.4 Implementatie
			\ganttfoobar[name=24]{2.4}{2021-03-12}{2021-04-02} \\
			%2.5 Assemblage
			\ganttfoobar[name=25]{2.5}{2021-03-19}{2021-03-19}
			\ganttfoobar[name=25]{2.5}{2021-03-26}{2021-03-26} \\ %Asssemblage: eind maart
			
		
			\ganttgroup{3}{2021-03-12}{2021-04-02} \\
			%3.1 Tussentijds verslag
			\ganttfoobar[name=31]{3.1}{2021-03-12}{2021-04-02} \\
		
			%3.2 Verslag afwerken
			\ganttfoobar[name=32]{3.2}{2021-04-23}{2021-05-21} \\
			%\ganttlink{31}{32}
			
			%3.3 Tussentijdse presentatie
			\ganttfoobar[name=33]{3.3}{2021-03-19}{2021-04-02} \\
		
			%3.4 Presentatie afwerken
			\ganttfoobar[name=34]{3.4}{2021-04-23}{2021-05-21} \\
			%\ganttlink{33}{34}
...
\begin{figure}
	...
	\begin{ganttchart}[hgrid, vgrid, x unit=5mm, time slot format=isodate]{2021-04-03}{2021-05-21}
		...
		\ganttgroup{3}{2021-04-03}{2021-05-21} \\
