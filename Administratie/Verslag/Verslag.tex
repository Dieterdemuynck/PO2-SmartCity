...
\begin{figure}
	\includegraphics[width=0.5]{1chassisaAndrijving}
	\centering
	\caption{Cassis met wielen, motoren en kogelwiel}
	\label{opbouw1}
\end{figure}

\begin{figure}
	\includegraphics[width=0.5]{2sensoren}
	\centering
	\caption{Cassis met wielen, motoren, kogelwiel en sensoren}
	\label{opbouw2}
\end{figure}

\begin{figure}
	\includegraphics[width=0.5]{3voorlaatste}
	\centering
%	\caption{Cassis met wielen, motoren, kogelwiel, sensoren, ....} is een caption hier zelfs nodig
\label{opbouw3}
\end{figure}

\begin{figure}
	\includegraphics[width=0.5]{4Volledig}
	\centering
