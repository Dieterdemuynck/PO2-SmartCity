...
Nu wat is de maatschappelijke relevantie van een zelfrijdende auto? Bedrijven zoals Tesla, BMW, Mercedes en Uber zijn bezig met de ontwikkeling van zelfrijdende auto's. Een autonome auto heeft een snellere reactie dan mensen. Hierdoor zullen er ongevallen vermeden worden. Door de snellere reactie, zullen er ook minder files zijn. Het biedt dus ook een oplossing voor mobiliteitsproblemen. Een autonome auto kiest ook voor de kortste weg. Hierdoor legt de auto minder kilometers af. Deze soort auto's staat dus niet enkel in voor de verkeersveiligheid, maar ook voor meer milieubewust autotransport \cite{AutonomeAutos1, AutonomeAutos2}. 
