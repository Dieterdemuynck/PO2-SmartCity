...
\begin{document}
	...
	\begin{tikzpicture}[node distance = 3cm, auto]\label{flowchart kleursensor}
		...
		\node [block, below left of=Groen] (volgende) {Ga naar sequentie 2};
		\node [block, below right of=Groen] (opnieuw) {Blijf op sequentie 1};
		\node [block, below of=controle] (waarde) {Onthou de waarde};
		\node [block, below of=waarde] (herbegin) {Blijf op sequentie 1};
		%place paths
