...
\documentclass
   [kulak,aspectratio=169,<options>] % options: kul or kulak (default), handout 
   {kulakbeamer}
...
\begin{frame}
	\frametitle{Frame en motoren} %chassis + wielen + motoren
...
\begin{frame}
	...
	\begin{tikzpicture}[scale=0.8]
		\hspace*{3cm}
		\pie [rotate = 180]
		{39/ Bieding, 6/ Wielen en chassis, 13/ Motoren, 12/ Microcontroller en batterij, 5/ Draden en mechanische stukken, 13/ Sensoren, 4/ Extra, 8/ Niet uitgegeven}
	\end{tikzpicture}
\end{frame}
...
\begin{frame}
	\frametitle{Basisprogramma}
	\begin{figure}
		\centering
		\includegraphics[width=.35\textwidth,]{flowchartBegin}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=.8\textwidth]{modelstad}
